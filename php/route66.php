    ...
    <body>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <th><?php echo $reg['idroute'];?></th>
                    <td><?php echo $reg['nombreroute'];?></td>
                    <td><?php echo $reg['descripcionroute'];?></td>
                    <td><?php echo $reg['cantidadroute'];?></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
