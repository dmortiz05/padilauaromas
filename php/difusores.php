    ...
    <body>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <th><?php echo $reg['iddifusor'];?></th>
                    <td><?php echo $reg['nombredifusor'];?></td>
                    <td><?php echo $reg['descripciondifusor'];?></td>
                    <td><?php echo $reg['cantidaddifusor'];?></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
