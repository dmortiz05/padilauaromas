    ...
    <body>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <th><?php echo $reg['idtextil'];?></th>
                    <td><?php echo $reg['nombretextil'];?></td>
                    <td><?php echo $reg['descripciontextil'];?></td>
                    <td><?php echo $reg['cantidadtextil'];?></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
