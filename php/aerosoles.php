    ...
    <body>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <th><?php echo $reg['idaerosol'];?></th>
                    <td><?php echo $reg['nombreaerosol'];?></td>
                    <td><?php echo $reg['descripcionaerosol'];?></td>
                    <td><?php echo $reg['cantidadaerosol'];?></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
