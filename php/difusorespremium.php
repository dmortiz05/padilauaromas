        ...
        <table class="table">
            ...
            <tbody>
                ...
                <?php 
                    ...
                    $query = "SELECT * FROM difusorpremium ";
                ...
                <tr>
                    <th><?php echo $reg['iddifusorpremium'];?></th>
                    <td><?php echo $reg['nombredifusorpremium'];?></td>
                    <td><?php echo $reg['descripciondifusorpremium'];?></td>
                    <td><?php echo $reg['cantidaddifusorpremium'];?></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
